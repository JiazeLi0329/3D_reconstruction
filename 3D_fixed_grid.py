...
from utils_3d import create_segment, coordinates_moving_operation, is_present, determine_color, create_floor_wall, create_kpts_xyd
...
'''
        ...
        ###########################################################################################
            ...
            create_floor_wall(vis)

            if kpts_xyvd is not None:
                kpts_xyd = create_kpts_xyd(kpts_xyvd)
                object_coordinates = coordinates_moving_operation(kpts_xyd)
